 ...
 */
public class DrawingPanelSimplifyed implements ImageObserver {
    // class constants
    ...
    private static final List<DrawingPanelSimplifyed> INSTANCES = new ArrayList<DrawingPanelSimplifyed>();
    ...
    public static void saveAll() throws IOException {
        for (DrawingPanelSimplifyed panel : INSTANCES) {
     ...
     */
    public DrawingPanelSimplifyed(int width, int height) {
     ...
     */
    public DrawingPanelSimplifyed(File imageFile) {
     ...
     * @throws RuntimeException if the image file is not found
     */
    public DrawingPanelSimplifyed(String imageFileName) {
        this();
